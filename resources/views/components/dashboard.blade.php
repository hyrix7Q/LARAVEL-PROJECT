            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Prospects:</h6>
                        <a class="collapse-item" href="prospects">See Prospects</a>
                        <a class="collapse-item" href="prospect/create">Add Prospects</a>
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item">
                ...
                <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="commercial/create">Add a commercial</a>
                        <a class="collapse-item" href="commercial">See commercials</a>
